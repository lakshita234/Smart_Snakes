...
class Food:
    def __init__(self):
        self.size = int(window_item.scale_factor * 10)
        self.x = int(round(randrange(0, int(window_item.scrW) - self.size) / self.size) * self.size)
        self.y = int(round(randrange(0, int(window_item.scrH) - self.size) / self.size) * self.size)
